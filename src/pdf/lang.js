...
const EN = '\\b(the|and|of|to|in|for|with|this|that|from|are|was|we|is|on|as|by|an|a|be|or|it)\\b'
const ES = '\\b(el|la|los|las|del|una|para|con|por|que|este|esta|como|más|un|se|al)\\b'
...
const count = (text, pattern) => (text.match(new RegExp(pattern, 'gi')) || []).length
