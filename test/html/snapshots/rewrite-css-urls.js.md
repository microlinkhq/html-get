...
## rewrites non-root-relative CSS URLs
...
> Snapshot 1
    ...
    <html lang="en">␊
      <head>␊
        <style>␊
          .hero {␊
            background: url(https://example.com/blog/images/bg.jpg)␊
          }␊
          .icon {␊
            background: url(https://example.com/blog/icons/star.png)␊
          }␊
          .logo {␊
            background: url(https://example.com/assets/logo.svg)␊
          }␊
        </style>␊
        <title>post</title>␊
